...
| --- | --- | --- |
| 2 | `const API_ENDPOINT = '../api/get_dashboard_data.php';` | Existing dashboard endpoint used to load initial dashboard data. |
| 3-6 | `const SEARCH_ENDPOINTS = { ... }` | Stores the two search URLs used by the dashboard. |
| 4 | `jobs: '../api/search_jobs.php'` | Jobs page search endpoint. |
| 5 | `staff: '../api/search_staff.php'` | Staff page search endpoint. |
...
| Lines | Code | What it does |
| --- | --- | --- |
| 669-672 | `getDefaultJobsPanelData()` | Gets the normal jobs list from loaded dashboard data. |
...
| 539-546 | `getDefaultStaffPanelData()` | Gets normal backend staff data. |
...
File: `src/admin/api/search_jobs.php`

| Line | Code | What it does |
| --- | --- | --- |
| 3 | `require __DIR__ . "/../../config/db.php"` | Opens the database connection. |
...
File: `src/admin/api/search_staff.php`
...
```text
http://localhost/mechanic-system/src/admin/api/search_jobs.php?q=AB
http://localhost/mechanic-system/src/admin/api/search_staff.php?q=Medin
```
